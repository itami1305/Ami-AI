...
from app.logic.reconciliation.message_store import list_session_ids
from app.logic.reconciliation.paths import ensure_export_dir
...
class ImageViewerDialog(QDialog):
    ...
    def _apply_zoom(self) -> None:
        ...
        if self._zoom_mode == "fit":
            ...
            viewport_w = max(200, viewport.width() - 4)
            viewport_h = max(200, viewport.height() - 4)
